(function(win, doc){ 
    ...
    */
    var prompt = win.prompt('Qual o seu nome?');
    var username = prompt ? prompt : 'Desconhecido';
    ...
    */
    $button.addEventListener('click', function(event){
        ...
        if($inputUsername.value === ''){
            ...
            var confirmation = win.confirm('Tem certeza que deseja enviar o formulário?');
    ...
    */
    ...
    function isValidEmail(email){
        var regex = new RegExp(/^((?:[\w_+.]){0,})@(\w{2,}(\.\w+)(\.\w{1,2})?)$/);
        console.log(regex, email, regex.test(email));
