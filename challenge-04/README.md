...
*/
carro.obterCor = function(x) { return carro.cor; }
...
carro.adicionarPessoas = function(pessoas) { 
  ...
  } else if(pessoas>(carro.assentos - carro.quantidadedePessoas)){
    return 'Só cabem mais ' + (carro.assentos - carro.quantidadedePessoas) + ' pessoa' + ((carro.assentos - carro.quantidadedePessoas) > 1 ? 's!' : '!');
  } else {
