(function(){
	...
	*/
	...
	var newText = text.replace(/Manuel Marques de Sousa/, 'Paulo Matheus Coimbra');
	console.log(newText);
	...
	*/
	...
	console.log(regexDate.toString());
	...
	*/
	...
	function replaceDate(date){
		var dateSplit = date.split(' de ');
		dateSplit[1] = getMonthNumber(dateSplit[1]);
		return dateSplit.join('/');
	};
	newText = text.replace(regexDate, function(capturaTotal, date){
