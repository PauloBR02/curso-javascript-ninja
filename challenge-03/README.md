...
*/
pessoa.nomeCompleto() //"Olá! Meu nome é Paulo Coimbra!"
...
*/
pessoa.caminhouQuantosMetros //84
...
pessoa.apresentacao = function(){
  ...
  if(pessoa.idade===1){
    ...
    textoRetorno+=', tenho ' + pessoa.idade + ' anos, ';
  }
  textoRetorno+=pessoa.altura + ', meu peso é ' + pessoa.peso + ' e, só hoje, eu ja caminhei ' + pessoa.caminhouQuantosMetros;
