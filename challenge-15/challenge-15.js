...
var pessoa = new Person('Paulo', 'Coimbra', 24);
console.log(pessoa.addAge(2));
  ...
  */
  ...
  var person1 = new Person('Ana', 'Julia', 23);
  var person2 = new Person('Paulo', 'Coimbra', 24);
  var person3 = new Person('Fernando', 'Cabral', 57);
  console.log(person1);
  console.log(person2);
  console.log(person3);
  ...
  */
  ...
  console.log(person3.getFullName() + ' agora tem ' + person3.addAge(9).getAge() + ' anos.');
